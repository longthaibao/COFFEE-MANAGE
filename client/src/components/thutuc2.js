    ...
    <div className="w-full flex justify-center items-center bg-cover">
      <div className="w-full h-222 bg-white rounded-2xl flex items-center flex-col p-4">
        <h1 className="text-gray-700 text-2xl font-bold">
          Thống kê các chương trình khuyến mãi có Doanh thu (VNĐ) lớn hơn hoặc
          bằng R theo năm và hiển thị kèm thông tin của Khách hàng đã chi nhiều
          nhất trong CTKM đó
        </h1>
        <Box
          component="form"
        ...
        <div className="mb-4 text-gray-600 text-sm text-red-500">
          NOTE:
          <p>
            Điều kiện áp dụng là số lớn hơn 1000 là điều kiện áp dụng đối với
            Khuyến mãi theo hóa đơn (Đơn vị: VNĐ)
          </p>
          <p>
            Điều kiện áp dụng là số nhỏ là điều kiện áp dụng đối với Khuyến mãi
            theo sản phẩm
          </p>
        </div>
        {headers.length > 0 && (
